...
public class SelectByExamplePageResultWithoutBLOBsMethodGenerator extends AbstractDAOElementGenerator {
	private boolean generateForJava5;

	public SelectByExamplePageResultWithoutBLOBsMethodGenerator(boolean generateForJava5) {
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		if (this.ibatorContext.getTurnPageType() == null) {
			...
			sb.append(".");
			sb.append(XmlConstants.SELECT_BY_EXAMPLE_STATEMENT_ID);
			sb.append("\", \"");
			sb.append(table.getSqlMapNamespace());
			sb.append(".");
		...
		topLevelClass.addImportedType(this.ibatorContext.getPageResultType());
