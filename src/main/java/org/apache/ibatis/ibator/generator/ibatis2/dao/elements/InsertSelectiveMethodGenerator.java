...
public class InsertSelectiveMethodGenerator extends AbstractDAOElementGenerator {
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		sb.append(this.daoTemplate.getInsertMethod(table.getSqlMapNamespace(),
				XmlConstants.INSERT_SELECTIVE_STATEMENT_ID, "record"));
		...
		if (this.ibatorContext.getPlugins().daoInsertSelectiveMethodGenerated(method, topLevelClass,
	...
	public void addInterfaceElements(Interface interfaze) {
		...
		if (this.ibatorContext.getPlugins().daoInsertSelectiveMethodGenerated(method, interfaze,
				this.introspectedTable)) {
	...
	private Method getMethodShell(Set<FullyQualifiedJavaType> importedTypes) {
		...
		method.setName(getDAOMethodNameCalculator().getInsertSelectiveMethodName(this.introspectedTable));
