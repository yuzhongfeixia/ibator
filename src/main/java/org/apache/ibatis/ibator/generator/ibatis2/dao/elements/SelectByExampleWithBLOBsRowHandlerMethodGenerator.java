...
public class SelectByExampleWithBLOBsRowHandlerMethodGenerator extends AbstractDAOElementGenerator {
	private boolean generateForJava5;

	public SelectByExampleWithBLOBsRowHandlerMethodGenerator(boolean generateForJava5) {
	...
	public void addImplementationElements(TopLevelClass topLevelClass) {
		...
		sb.append(this.daoTemplate.getQueryWithRowHandlerMethod(table.getSqlMapNamespace(),
				XmlConstants.SELECT_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID, "example", "rowHandler"));
